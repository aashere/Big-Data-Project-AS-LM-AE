...
public class OrganizeMonths{
 public static void main(String[] args) throws Exception {
 //we create a new job and set the class and the name of the job
 Job job = new Job();
 job.setJarByClass(OrganizeMonths.class);
 job.setJobName("Organize Months");
 ...
 job.setMapperClass(OrganizeMonthsMapper.class);
 job.setReducerClass(OrganizeMonthsReducer.class);
